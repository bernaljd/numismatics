import { updateCoin } from "@/app/actions/collection"
...
export default async function EditCoinPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const updateCoinWithId = updateCoin.bind(null, id)
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8">
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Actualiza la información de tu moneda
            </p>
          </div>

          <form action={updateCoinWithId} className="space-y-6">
            {/* Imagen actual */}
            <div>
              ...
              <img 
                src={coin.imagen!} 
                alt={coin.denominacion}
                className="w-full h-48 object-cover rounded-lg mb-2"
              />
              <input type="hidden" name="imagenActual" value={coin.imagen!} />
            </div>
            ...
            <div>
              ...
              <YearInput defaultValue={coin.anio} />
            </div>
            ...
            <div>
              ...
              <input
                ...
                name="denominacion"
                required
                defaultValue={coin.denominacion}
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
